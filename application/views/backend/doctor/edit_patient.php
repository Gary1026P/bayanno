            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('doctor/patient/update/'.$row['patient_id']); ?>" 
                        ...
                        <div class="form-group">
                        <label class="col-sm-3 control-label">Upload doc 1</label>

                        <div class="col-sm-7">

                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <a href="<?= base_url('/uploads/patient_doc/'.$row['doc_1'])?>"   <span class="fileinput-new"> Download Doc 1</span></a>
                                <div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Upload doc 2</label>

                        <div class="col-sm-7">

                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <a href="<?= base_url('/uploads/patient_doc/'.$row['doc_2'])?>"   <span class="fileinput-new"> Download Doc 2</span></a>
                                <div>
                                    <span class="">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Upload doc 3</label>

                        <div class="col-sm-7">

                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <a href="<?= base_url('/uploads/patient_doc/'.$row['doc_3'])?>"   <span class="fileinput-new"> Download Doc 3</span></a>
                                <div>
                                    <span class="">
